        ...
        ?>
          <div class="ui feed">
            <div class="event">
              ...
              <div class="content">
                <a><?=$user->username?></a> accepted you request to join <a><?php $x = $r->project_id; echo get_project_name($x, $connect_link)?></a>
              </div>
            </div>
          </div>
        <?php
  ...
  if ($pending_requests != null) {
    while ($req = mysqli_fetch_object($pending_requests)) {
      ...
      <div class="event">
        ...
        <div class="content">
          Request pending for <a><?php $x=$req->project_id;echo get_project_name($x, $connect_link)?></a>
        </div>
      </div>
    </div>
      <?php
    ...
    <div class="extra content">
      <div class="ui two buttons">
        ...
        <div class="ui basic red button">Decline</div>
					...
					echo "<h3>Seems like no one has seen this proect yet.<h3>";
				}
			?>
...
<div class="row" >
	...
	<div class="approved-project-requests">
		<div class="section-heading" style="margin-bottom: 20px; margin-top: 20px;padding-left: 15px;">
